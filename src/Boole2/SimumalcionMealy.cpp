/*$T boole/Boole2/SimumalcionMealy.cpp GC! 1.116 05/02/01 18:53:24 */
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TFormMealy::FormShow(TObject *Sender)
{
	FormMealy->Fe1->ReadOnly = false;
	FormMealy->Fe1->Color = clWindow;
	if(Entradas > 1)
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TFormMealy::BitBtn3Click(TObject *Sender)
{
	AFea = "";
	AFs1 = "";
	AFs2 = "";
	...
	FormMealy->Fe4->ReadOnly = true;
	FormMealy->Fe5->ReadOnly = true;
	FormMealy->Fe1->Color = clSilver;
	FormMealy->Fe2->Color = clSilver;
	FormMealy->Fe3->Color = clSilver;
	FormMealy->Fe4->Color = clSilver;
	FormMealy->Fe5->Color = clSilver;
	FormMealy->Fs1->Color = clSilver;
	FormMealy->Fs2->Color = clSilver;
	FormMealy->Fs3->Color = clSilver;
	FormMealy->Fs4->Color = clSilver;
	FormMealy->Fs5->Color = clSilver;

	FormMealy->Button1->Enabled = true;
	FormMealy->Button2->Enabled = false;
	FormMealy->Button4->Enabled = false;
	FormMealy->Button5->Enabled = false;
	cont = 0;
	FormMealy->Close();
}
