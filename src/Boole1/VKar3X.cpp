/*$T boole/Boole1/VKar3X.cpp GC! 1.116 05/02/01 18:53:23 */
...
/*
 ...
 =======================================================================================================================
 */
__fastcall TVK3X::TVK3X(TComponent *Owner) :
	TForm(Owner)
{
}
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK3X::FormShow(TObject *Sender)
{
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK3X::FuncionLabelMouseMove(TObject *Sender, TShiftState Shift, int X, int Y)
{
	FuncionLabel->Hint = Tabla.LeerSalida(numFuncion3X - 1);
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK3X::FuncionMouseMove(TObject *Sender, TShiftState Shift, int X, int Y)
{
	Funcion->Hint = Tabla.LeerSalida(numFuncion3X - 1);
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK3X::ScrollBar1Change(TObject *Sender)
{
	// ajustamos el grid a la posición adecuada
	numFuncion3X = ScrollBar1->Position;
	Funcion->Caption = numFuncion3X;
	StringGridVK->TopRow = (numFuncion3X - 1) * 2 + 1;
	StringGridVK->Row = (numFuncion3X - 1) * 2 + 1;
	StringGridVK->Col = 1;
}
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK3X::StringGridVKKeyDown(TObject *Sender, WORD &Key, TShiftState Shift)
{
	if((Key == 38) & (ScrollBar1->Position != 1) & (StringGridVK->Row == (numFuncion3X - 1) * 2 + 1))
	{
		ScrollBar1->Position = ScrollBar1->Position - 1;
		StringGridVK->Row = numFuncion3X * 2;
	}
	else if
		(
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK3X::StringGridVKMouseDown(TObject *Sender, TMouseButton Button, TShiftState Shift, int X, int Y)
{
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	/*
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK3X::Button1Click(TObject *Sender)
{
	/*~~~~~~~~~~~~~~~~~~*/
	bool	error = false;
	/*~~~~~~~~~~~~~~~~~~*/
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK3X::Button2Click(TObject *Sender)
{
	for(int i = 1; i < 3; i++)
	{
		for(int j = 1; j < 5; j++)
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK3X::SalirClick(TObject *Sender)
{
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK3X::libresClick(TObject *Sender)
{
	for(int i = 1; i < 3; i++)
	{
		for(int j = 1; j < 5; j++)
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK3X::cerosClick(TObject *Sender)
{
	for(int i = 1; i < 3; i++)
	{
		for(int j = 1; j < 5; j++)
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK3X::unosClick(TObject *Sender)
{
	for(int i = 1; i < 3; i++)
	{
		for(int j = 1; j < 5; j++)
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK3X::BitBtn1Click(TObject *Sender)
{
	/*~~~~~~~~~~~~~~~~~~*/
	bool	error = false;
	/*~~~~~~~~~~~~~~~~~~*/
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK3X::BitBtn2Click(TObject *Sender)
{
	for(int i = 1; i < 3; i++)
	{
		for(int j = 1; j < 5; j++)
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK3X::BitBtn3Click(TObject *Sender)
{
	// volvemos al form de creacion de un nuevo sistema combinacional
	SistemaCombinacionalNuevo->Show();
	VK3X->Hide();
