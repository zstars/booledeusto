/*$T boole/Boole1/Vkar6.cpp GC! 1.116 05/02/01 18:53:24 */
...
/*
 ...
 =======================================================================================================================
 */
__fastcall TVK6::TVK6(TComponent *Owner) :
	TForm(Owner)
{
}
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK6::StringGridVKMouseDown(TObject *Sender, TMouseButton Button, TShiftState Shift, int X, int Y)
{
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	/*
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK6::SalirClick(TObject *Sender)
{
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK6::FormShow(TObject *Sender)
{
	...
	for(int i = 0; i < Tabla.NumColumnas(); i++)
	{
		...
		StringGridVK->Cells[0][i * 8 + 2] = "100";
		StringGridVK->Cells[0][i * 8 + 3] = "110";
		StringGridVK->Cells[0][i * 8 + 4] = "010";
		StringGridVK->Cells[0][i * 8 + 5] = "011";
		StringGridVK->Cells[0][i * 8 + 6] = "111";
		StringGridVK->Cells[0][i * 8 + 7] = "101";
		StringGridVK->Cells[0][i * 8 + 8] = "001";
	}
	...
	Panel6->Hint = Tabla.LeerEntrada(1);
	Label6->Hint = Tabla.LeerEntrada(1);
	Panel7->Hint = Tabla.LeerEntrada(3);
	Label7->Hint = Tabla.LeerEntrada(3);
	Panel8->Hint = Tabla.LeerEntrada(5);
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK6::Button2Click(TObject *Sender)
{
	for(int i = 1; i < 9; i++)
	{
		for(int j = 1; j < 9; j++)
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK6::FuncionMouseMove(TObject *Sender, TShiftState Shift, int X, int Y)
{
	Funcion->Hint = Tabla.LeerSalida(numFuncion6 - 1);
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK6::FuncionLabelMouseMove(TObject *Sender, TShiftState Shift, int X, int Y)
{
	FuncionLabel->Hint = Tabla.LeerSalida(numFuncion6 - 1);
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK6::ScrollBar1Change(TObject *Sender)
{
	// ajustamos el grid a la posición adecuada
	numFuncion6 = ScrollBar1->Position;
	Funcion->Caption = numFuncion6;
	StringGridVK->TopRow = (numFuncion6 - 1) * 8 + 1;
	StringGridVK->Row = (numFuncion6 - 1) * 8 + 1;
	StringGridVK->Col = 1;
}
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK6::StringGridVKKeyDown(TObject *Sender, WORD &Key, TShiftState Shift)
{
	// ShowMessage (StringGridVK->Row)
	if((Key == 38) & (ScrollBar1->Position != 1) & (StringGridVK->Row == (numFuncion6 - 1) * 8 + 1))
	{
		ScrollBar1->Position = ScrollBar1->Position - 1;
		StringGridVK->Row = numFuncion6 * 8;
	}
	else if
		(
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK6::Button1Click(TObject *Sender)
{
	/*~~~~~~~~~~~~~~~~~~*/
	bool	error = false;
	/*~~~~~~~~~~~~~~~~~~*/
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK6::libresClick(TObject *Sender)
{
	for(int i = 1; i < 9; i++)
	{
		for(int j = 1; j < 9; j++)
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK6::cerosClick(TObject *Sender)
{
	for(int i = 1; i < 9; i++)
	{
		for(int j = 1; j < 9; j++)
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK6::unosClick(TObject *Sender)
{
	for(int i = 1; i < 9; i++)
	{
		for(int j = 1; j < 9; j++)
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK6::BitBtn1Click(TObject *Sender)
{
	/*~~~~~~~~~~~~~~~~~~*/
	bool	error = false;
	/*~~~~~~~~~~~~~~~~~~*/
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK6::BitBtn2Click(TObject *Sender)
{
	for(int i = 1; i < 9; i++)
	{
		for(int j = 1; j < 9; j++)
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall TVK6::BitBtn3Click(TObject *Sender)
{
	// volvemos al form de creacion de un nuevo sistema combinacional
	SistemaCombinacionalNuevo->Show();
	VK6->Hide();
