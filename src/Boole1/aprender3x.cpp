/*$T boole/Boole1/aprender3x.cpp GC! 1.116 05/02/01 18:53:22 */
...
DinArray		Tabla3 = DinArray();
#pragma link "Grids"
#pragma resource "*.dfm"
Taprender3		*aprender3;
...
// =======================================================================================================================
//
void TransformarCadena3(AnsiString cadena, int funcion)
{
	/*~~~~~~~~~~~~~~~~~~~~~~*/
	// extern DinArray Tabla2;
	AnsiString	posicion = "";
	bool		roto = false;
	/*~~~~~~~~~~~~~~~~~~~~~~*/

	for(int i = 0; i < Tabla3.NumEntradas(); i++)
	{
		/*~~~~~~*/
		...
		else if(char(*cadena.SubString(z, 1).c_str()) > ('A' + i))
		{
			if(cadena.SubString(z - 1, 1) == "-")
			{
				...
				TransformarCadena3(cadena, funcion);
				cadena.Insert("-", z - 1);
			}
			else
			{
	...
	{
		Tabla3.EscribirDinArray(binario(posicion), funcion, '1');
		roto = true;
	}
}
...
/*
 ...
 =======================================================================================================================
 */
void EjecutarExpresion3(AnsiString cadena, int funcion)
{
	/*~~~~~~~~~~~~~~~~~~~~~*/
		...
		case '+':
			{
				...
				EjecutarExpresion3(cadena2, funcion);
	...
	if(cadena != "0") TransformarCadena3(cadena, funcion);
}
...
/*
 ...
 =======================================================================================================================
 */
__fastcall Taprender3::Taprender3(TComponent *Owner) :
	TForm(Owner)
{
}
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall Taprender3::ScrollBar1Change(TObject *Sender)
{
	// ajustamos el grid a la posición adecuada
	numFuncion3XX = ScrollBar1->Position;
	Funcion->Caption = numFuncion3XX;
	Label6->Caption = numFuncion3XX;
	StringGrid1->LeftCol = numFuncion3XX - 1;
	StringGrid2->LeftCol = numFuncion3XX - 1;
	StringGrid1->Col = numFuncion3XX - 1;
	StringGrid2->Col = numFuncion3XX - 1;

	// ajustamos el grid a la posición adecuada
	StringGridVK->TopRow = (numFuncion3XX - 1) * 2 + 1;
	StringGridVK->Row = (numFuncion3XX - 1) * 2 + 1;
	StringGridVK->Col = 1;

	StringGrid3->LeftCol = numFuncion3XX - 1;
	StringGrid3->Col = numFuncion3XX - 1;
}
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall Taprender3::FormShow(TObject *Sender)
{
	Funcion->Caption = numFuncion3XX;
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall Taprender3::Label1MouseMove(TObject *Sender, TShiftState Shift, int X, int Y)
{
	Label1->Hint = Tabla.LeerSalida(numFuncion3XX - 1);
	Label1->ShowHint = true;
	Label4->Hint = Tabla.LeerSalida(numFuncion3XX - 1);
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall Taprender3::FuncionMouseMove(TObject *Sender, TShiftState Shift, int X, int Y)
{
	Label6->Hint = Tabla.LeerSalida(numFuncion3XX - 1);
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall Taprender3::StringGrid3KeyUp(TObject *Sender, WORD &Key, TShiftState Shift)
{
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall Taprender3::BorrarExpClick(TObject *Sender)
{
	for(int j = 0; j < Tabla.NumColumnas(); j++) StringGrid3->Cells[j][0] = "";
}
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall Taprender3::SalirExpClick(TObject *Sender)
{
	Tabla3.BorrarDinArray();
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall Taprender3::EvaluarExpClick(TObject *Sender)
{
	/*~~~~~~~~~~~~~~~~~~~~*/
	...
	if(todoBien)
	{
		// Introducimos los datos en la Tabla3 creandola
		Tabla3.BorrarDinArray();
		Tabla3.DinX("temporal", Tabla.NumEntradas(), Tabla.NumColumnas());

		// quitamos todos los espacios y ponemos en mayusculas
		for(int j = 0; j < Tabla3.NumColumnas(); j++)
		{
			...
			if((cadena != "0") & (cadena != "1"))
			{
				...
				for(int i = 1; i <= cadena.Length(); i++)
				{
					...
					else if(isalpha(char(*cadena.SubString(i, 1).c_str())))
					{
						if((estado == 0) | (estado == 1) | (estado == 2) | (estado == 4))
						{
							if(char(*cadena.SubString(i, 1).c_str()) > 'A' + Tabla3.NumEntradas() - 1)
		...
		if(todoBien)
		{
			for(int i = 0; i < Tabla3.NumFilas(); i++)
				for(int j = 0; j < Tabla3.NumColumnas(); j++) Tabla3.EscribirDinArray(i, j, '0');
			...
			for(int j = 0; j < Tabla3.NumColumnas(); j++)
			{
				...
				EjecutarExpresion3(cadena, j);
			}
		}

		ScrollBar1->Position = 1;

		// Comprobamos si Tabla y Tabla3 son iguales
		for(int i = 0; i < Tabla.NumFilas(); i++)
		{
			for(int j = 0; j < Tabla.NumColumnas(); j++)
			{
				if((Tabla.LeerDinArray(i, j) != Tabla3.LeerDinArray(i, j)) & (Tabla.LeerDinArray(i, j) != 'X'))
				{
					todoBien = false;
					break;
				}
...
/*
 ...
 =======================================================================================================================
 */
void __fastcall Taprender3::BitBtn4Click(TObject *Sender)
{
	if(Conjuntivo->Checked == true)
	{
