/***************************************************************************
                          rdSeleccionarIPs_QM_NHsesg2.h  -  description
                             -------------------
...
#ifndef RDSELECCIONARIPS_QM_NHSESG2_H
#define RDSELECCIONARIPS_QM_NHSESG2_H
...
/**
	...
	* siempre que es posible. La lista de implicantes primos se preprocesa,
	* y se le aplica un ordenado aleatorio. En general, esto produce mejores
	* resultados que explorar la lista sin preprocesar.
	*/
class rdSeleccionarIPs_QM_NHsesg2 : public rdSeleccionarIPs_QM  {
	public:
		/// Constructor. Recibe un puntero al simplificador al que pertenece.
		rdSeleccionarIPs_QM_NHsesg2(rdSimplificador *padre);
		/// Destructor
		~rdSeleccionarIPs_QM_NHsesg2();
